...
// Acrescentado Falta de Fase
// Acrescentado fotos hora cheia
...
void setup() {
  ...
  pinMode(FaltaFase, INPUT_PULLDOWN);          
  digitalWrite(FaltaFase, LOW);
  ...
  bot.sendMessage(CHAT_ID, "Sistema de Vigilância EEE BG04 liberado para funcionamento!", ""); 
...
void loop() {
  ...
  if (val == HIGH) {
    ...
    bot.sendMessage(CHAT_ID, "*** EEE Barra do Gil 04 *** \nALARME DE INVASÃO", "");
    sendPhoto = true;
    delay(1000);
  ...
  // valFF = digitalRead(FaltaFase);    
  // if (valFF == LOW)  
  // { 
  //   //for (int ff = 0; ff < 11; ff++) {
  //   Serial.println("ATENÇÃO: FALTA DE ENERGIA");           
  //   bot.sendMessage(CHAT_ID, "*** EEAT 2 Milagres *** \nATENÇÃO! FALTA DE ENERGIA", "");
  //   //sendPhoto = true;
  //   //delay(1000);
  //   //Serial.println("Enviando imagem capturada...");
  //   delay(5000); 
