...
#define FaltaEnergia 18
#define GeradorON 33
#define RodandoSeca 23
#define TesteSistema 32
#define AlertaNivelAlto 14
...
#define WIFI_SSID "E.E.E.B.P.02"
#define WIFI_PASSWORD "GCS9E03BP"
...
void setup() {
  ...
  bot.sendMessage(CHAT_ID, "Sistema de monitoramento de falhas EEE B. POTE 2 iniciado." , "");
  delay(1000);
...
void loop() 
{
  ...
  NAlto = digitalRead(AlertaNivelAlto);
    ...
    delay(1000);
    digitalWrite(ledPin, LOW);
    bot.sendMessage(CHAT_ID, "*** EEE B. POTE 2 *** \nEXTRAVASANDO", "");
    ...
    // TESTE DE COMUNICAÇÃO A CADA HORA //
    ...
    if (ntp.update()) {
      if (minuto == 01) {
        ...
        bot.sendMessage(CHAT_ID, "Teste de Comunicação horário EEE B. POTE 2","");
