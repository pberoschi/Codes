...
def abrindo_instagram(username,password, url):
    ...
    driver.find_element("xpath",'/html/body/div[4]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/button[2]').click()
    sleep(3)
...
def comentandoPost():
    ...
    # while 1 == 1:
    sleep(10)
    cmt = driver.find_element("xpath",'/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[1]/div[2]/section/main/div/div[1]/div/div[2]/div/div[4]/section/div/form/div/textarea')
    cmt.click()
