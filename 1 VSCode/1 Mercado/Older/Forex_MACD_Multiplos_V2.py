...
if not mt5.initialize(path="C:\\Program Files\\Zero Markets MetaTrader 5 Terminal\\terminal64.exe",login=130023874, server="ZeroMarkets-Live-1", password='Joh0516!'):
