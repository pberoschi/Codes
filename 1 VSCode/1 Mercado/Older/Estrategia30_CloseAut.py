...
def gbpusd():
    ...
    if (balancoDia <= 97723.88) & (agoraRes < '10:40'):
...
while True:
    gbpusd()
    print(f'BALANÇO PARCIAL DO DIA: ${mt5.account_info().balance}')
    time.sleep(300)